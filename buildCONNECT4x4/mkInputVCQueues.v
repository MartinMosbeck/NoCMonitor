...
//
// On Mon Oct 26 08:39:12 EDT 2015
//
...
module mkInputVCQueues(CLK,
  ...
  assign inputVCQueues_ifc_mf_ifc_new_tail$wget = fifoWrPtr__h3759 + 3'd1 ;
  assign inputVCQueues_ifc_mf_ifc_new_head$wget = fifoRdPtr__h4213 + 3'd1 ;
  ...
  assign inputVCQueues_ifc_mf_ifc_fifoMem$ADDR_IN =
	     { enq_fifo_in, fifoWrPtr__h3759 } ;
  assign inputVCQueues_ifc_mf_ifc_fifoMem$ADDR_OUT =
	     { deq_fifo_out, fifoRdPtr__h4213 } ;
  ...
  begin
    ...
    if (RST_N)
      if (EN_enq && IF_enq_fifo_in_THEN_NOT_inputVCQueues_ifc_mf_i_ETC___d88)
	$display("2Enqueing to full FIFO - fifo_in:%d", enq_fifo_in);
    if (RST_N)
      if (EN_enq && IF_enq_fifo_in_THEN_NOT_inputVCQueues_ifc_mf_i_ETC___d88)
	$write("");
    if (RST_N)
    ...
    if (RST_N)
      if (EN_enq && IF_enq_fifo_in_THEN_NOT_inputVCQueues_ifc_mf_i_ETC___d88)
	$display("Data dump of element that filled FIFO: %x", enq_data_in);
    if (RST_N)
      if (EN_enq && IF_enq_fifo_in_THEN_NOT_inputVCQueues_ifc_mf_i_ETC___d88)
